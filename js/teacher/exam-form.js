...
function getPageElements() {
    return {
        pageTitle:
            getElement(
                ".exam-form-header .dashboard-page-title"
            ),
...
function choiceRow(
    ...
    label.title =
        `Mark option ${optionLetter} as correct`;
        ...
        (
            ...
            getElements(
                ...
                (
                    ...
                    radio.id =
                        `question-${number}-correct-${suffix}`;
                    ...
                    option.id =
                        `question-${number}-option-${suffix}`;

                    option.name =
                        `questions[${index}][options][${option.dataset.optionId}]`;
                }
            );
...
async function initializeExamForm() {
    ...
    try {
        ...
        console.error(
            "Unable to initialize the exam form.",
            error
        );
